...
package com.google.marmaris.backend;
...
public class MyServlet extends HttpServlet {
    static Logger Log = Logger.getLogger(MyServlet.class.toString());
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        FirebaseOptions options = new FirebaseOptions.Builder()
                .setServiceAccount(getServletContext().getResourceAsStream("/WEB-INF/gr-eap-dxt-marmaris-scrumtool-e99975df68b9.json"))
                .setDatabaseUrl("https://gr-eap-dxt-marmaris-scrumtool.firebaseio.com/")
                .build();
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress("reminder@gr-eap-dxt-marmaris-scrumtool.appspotmail.com",
                            "Todo Reminder"));
                    msg.addRecipient(Message.RecipientType.TO,
                            new InternetAddress("[lenatsimopoulou@GMAIL.COM]", "Recipient"));
